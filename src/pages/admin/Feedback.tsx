    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-ata-gray">
        ...
        <div className="flex-1">
          ...
          <main className="p-6">
            <div className="mb-8">
              <h1 className="text-2xl font-semibold text-ata-blue">Feedback Management</h1>
              <p className="text-ata-text mt-2">View and manage employee feedback</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="p-6">
                <h3 className="font-semibold mb-2">Total Feedback</h3>
                <div className="text-3xl font-bold text-ata-blue">24</div>
              </Card>
